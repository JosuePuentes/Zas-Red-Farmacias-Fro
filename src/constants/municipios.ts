// Subset of municipalities per state (Venezuela). Backend can hold the full list.
...
export const MUNICIPIOS_POR_ESTADO: Record<string, string[]> = {
  ...
  Anzoátegui: ['Anaco', 'Bolívar', 'Bruzual', 'Cajigal', 'Carvajal', 'Freites', 'Guanipa', 'Guanta', 'Independencia', 'Libertad', 'McGregor', 'Miranda', 'Monagas', 'Peñalver', 'Píritu', 'San Juan de Capistrano', 'Santa Ana', 'Simón Rodríguez', 'Sotillo'],
  ...
  Bolívar: ['Caroní', 'Cedeño', 'El Callao', 'Gran Sabana', 'Heres', 'Piar', 'Angostura', 'Roscio', 'Sifontes', 'Sucre', 'Padre Pedro Chien'],
  ...
  Guárico: ['Camaguán', 'Chaguaramas', 'El Socorro', 'Francisco de Miranda', 'Gerónimo', 'Guzmán Blanco', 'Infante', 'Lás Mercedes', 'Mellado', 'Miranda', 'Monagas', 'Ortiz', 'Ribas', 'San José de Guaribe', 'Santa María de Ipire', 'Sebastián Francisco de Miranda', 'Zaraza'],
  ...
  Táchira: ['Andrés Bello', 'Antonio Rómulo Costa', 'Ayacucho', 'Bolívar', 'Cárdenas', 'Córdoba', 'Fernández Feo', 'Francisco de Miranda', 'García de Hevia', 'Guásimos', 'Independencia', 'Jáuregui', 'José María Vargas', 'Junín', 'Libertador', 'Libertad', 'Lobatera', 'Michelena', 'Panamericano', 'Pedro María Ureña', 'Rafael Urdaneta', 'Samuel Darío Maldonado', 'San Cristóbal', 'Seboruco', 'Simón Rodríguez', 'Sucre', 'Torbes', 'Uribante'],
  Trujillo: ['Andrés Bello', 'Bocono', 'Bolívar', 'Candelaria', 'Carache', 'Escuque', 'José Felipe Márquez Cañizalez', 'Juan Vicente Campos Elías', 'La Ceiba', 'Miranda', 'Monte Carmelo', 'Motatán', 'Pampán', 'Pampanito', 'Rafael Rangel', 'San Rafael de Carvajal', 'Sucre', 'Urdaneta', 'Valera'],
  Vargas: ['Vargas'],
