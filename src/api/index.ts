...
export const masterApi = {
  ...
  aprobarDelivery: (id: string) => request(`/master/solicitudes-delivery/${id}/aprobar`, { method: 'POST' }),
  denegarDelivery: (id: string) => request(`/master/solicitudes-delivery/${id}/denegar`, { method: 'POST' }),
